...
class MultiBranchModel(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
      ...
      self.log('val_top1', top_1, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('val_top5', top_5, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('val_top10', top_10, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('val_top1%', top_percent1, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)

      self.log('val_top1_inv', top_1_inverse, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('val_top5_inv', top_5_inverse, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('val_top10_inv', top_10_inverse, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('val_top1%_inv', top_percent1_inverse, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
    ...
    def on_test_epoch_end(self):
      ...
      self.log('test_top1', top_1, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('test_top5', top_5, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('test_top10', top_10, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('test_top1%', top_percent1, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)

      self.log('test_top1_inv', top_1_inverse, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('test_top5_inv', top_5_inverse, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('test_top10_inv', top_10_inverse, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
      self.log('test_top1%_inv', top_percent1_inverse, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
